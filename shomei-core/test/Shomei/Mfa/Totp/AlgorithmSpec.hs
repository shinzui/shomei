-- | RFC 6238 conformance for "Shomei.Mfa.Totp.Algorithm": the Appendix B vectors, the ±1 acceptance
-- window, the strictly-greater replay rule, and a Base32 round-trip.
module Shomei.Mfa.Totp.AlgorithmSpec (tests) where

import Data.Text (Text)
import Data.Time.Clock.POSIX (posixSecondsToUTCTime)
import Shomei.Mfa.Totp.Algorithm
